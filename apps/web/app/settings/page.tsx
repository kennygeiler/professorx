            ...
            <SettingsSection title="Chrome Extension">
              <div className="space-y-2 py-2">
                <p className="text-xs text-zinc-500">
                  The extension syncs your tweets by scrolling your Twitter likes page.
                  Connect it using the API_KEY from your .env file.
                </p>
                <div className="rounded-lg bg-zinc-800/50 p-3 text-xs text-zinc-400 font-mono">
                  API_KEY from .env → paste into extension popup
                </div>
              </div>
            </SettingsSection>
